...
namespace MemberAdmin
{
  ...
  public static class TableExtensions
  {
    ...
    public static void AddRow(this Table table, string text, int columnSpan)
    {
      Label label = new Label();
      label.Text = text;
      table.AddRow(label, columnSpan);
    }
    ...
    /// <param name="text">The text.</param>
    /// <param name="columnSpan">The column span.</param>
    public static void AddHeaderRow(this Table table, string text, int columnSpan)
    {
      Label label = new Label();
      label.Font.Bold = true;
      label.Text = text;
    ...
    /// <param name="columnSpan">The column span.</param>
    public static void AddRow(this Table table, Control control, int columnSpan)
    {
      var tableRow = new TableRow();
      var tableCell = new TableCell();
